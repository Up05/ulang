...
public class Ast {
    ...
    static class Array extends Ast { List<Ast> values; }
    ...
    static class Decl   extends Ast { String name; Class type; Ast value; }
    static class FnDecl extends Ast { String name; Class ret; List<Ast.Decl> args; List<Ast> body; }

    static class Assign extends Ast { String name; Ast value; }
    static class Var    extends Ast { String name; }
    static class Const  extends Ast { Object value; }
